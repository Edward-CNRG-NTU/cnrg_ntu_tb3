...
model_dir = '/home/cnrg-ntu/catkin_ws/src/cnrg_ntu_tb3/central_auditory_model/auditory_model/crnn_best/'
...
def run_angle_estimator():    
    ...
    model = load_model(model_dir + '20180719231113_crnn_model_0.88.hdf5')
    param = np.load(model_dir + '20180719231113_crnn_param.npz')
    ...
    while not rospy.is_shutdown():        
        ...
        acm_data = np.stack([mso_data, lso_data, ic_data], axis=-1).reshape((1,) + ic_data.shape + (-1,))
